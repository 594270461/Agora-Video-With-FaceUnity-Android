    ...
    private void setConfig() {
        ...
        IVideoSource source = new IVideoSource() {
            ...
            public boolean onInitialize(IVideoFrameConsumer iVideoFrameConsumer) {
                FUExampleActivity.this.mIVideoFrameConsumer = iVideoFrameConsumer;
                return true;
            }

            @Override
            public boolean onStart() {
                FUExampleActivity.this.mVideoFrameConsumerReady = true;
                return true;
            }

            @Override
            public void onStop() {
                FUExampleActivity.this.mVideoFrameConsumerReady = false;
            }
